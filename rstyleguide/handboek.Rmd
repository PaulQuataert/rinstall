...
Gebruik steeds ren consistente volgorde van de argumenten van een functie. Gebruik steeds expliciet de naam van de argumenten wanneer het gaat om zelfgedefinieerde functies. In het geval van functies uit de standaard `R` packages hoef je de standaard argumenten niet te benoemen als dat geen negatieve invloed heeft op de leesbaarheid.
