...
- Wanneer _ignore_ gebruiken
    - Vuistregel: telkens je het bestand in kwestie makkelijk kan aanmaken met de gegevens in de _repository_
...
- _checkout_ **master**
    ...
    - ofwel: in het `Git` tabblad klikken op de naam van het huidige _branch_. Kies vervolgens de **master** _brnach_ uit de drop-down lijst
