...
Om de inhoud van andersmans _repository_ te wijzigen maken we een _pull request_. Eerst en vooral moeten we uiteraard een aantal wijzigingen aanbrengen in onze eigen _fork_. Om de automatische _fork syncing_ te behouden, werken we best in een nieuwe _branch_.
...
- Klik in het linkermenu op `Pull requests` 
    ...
    - Optioneel kan je reviewers opgeven. Deze personen kunnen dan hun goedgekeuring geven over de _pull request_.
...
- De `Edit` knop rechtsboven laat je toe om de doel_branch_, titel en beschrijving aan te passen. Je kan eventueel de lijst van reviewers bijwerken.
...
`git config --global credential.helper cache`
  ~ onthoudt je wachtwoord tijdelijk. Vooral handig als je frequent _pullt_ of _pushed_
...
- Voorbeeld bruikbaar in `gitdemo_lessenreeeks`: `git checkout 7c9f .`
